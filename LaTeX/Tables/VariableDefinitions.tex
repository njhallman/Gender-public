\begin{longtable}{>{\raggedright\arraybackslash}p{3cm}p{13cm}}
    ...
    \TOPUNIV & An indicator variable set equal to 1 if the professional attended a top 100 university according to the \textit{us\_rank} field in Revelio, 0 otherwise. Revelio bases their rankings on the US News and World Report.\\
    \midrule 
